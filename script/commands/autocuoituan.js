...
const weekendMessages = [
  {
    timer: '9:00:00 AM',
    saturdayMessage: [
    'Đã cuối tuần rồi sao, thay mặt đội ngũ HT2K Company. Bot xin chúc tất cả mọi người trong box có 1 ngày cuối tuần thật vui vẻ!', 
  ...
  },
  {
    ...
    sundayMessage: ['Vào lúc 00:01 ngày đầu tuần, Hệ thống bot HT2K sẽ tự động reset data check tương tác của tất cả các nhóm, các bạn quản trị viên chú ý lọc thành viên nhé\n/checktv week - để xem tất cả tương tác cuối tuần\n/checktv locmem <số tin nhắn muốn lọc> - để bot tự lọc thành viên nhé']
  }
];
