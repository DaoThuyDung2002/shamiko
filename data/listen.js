...
//DEFINE DATLICH PATH
  ...
  return async (event) => {
    ...
    body: `=== 『 WARNING NO DATA 』 ===\n━━━━━━━━━━━━━━━━\n[⛔] ➜ Nhóm của bạn chưa có hồ sơ trong Data Center của hệ thống. Vui lòng liên hệ Nhà điều hành đăng ký và lập hồ sơ hệ thống để tiếp tục sử dụng\n\n[⚜️] ➜ Liên hệ các Quản lý viên\nFacebook Co-Owner: Đào Thị Kiều Anh 💝🌹 (Meow)\nhttps://www.facebook.com/User.daokieuanh.FAQ\nFacebook Admin DataCenter: Mẫn Kiều Linh (Ayato)\nhttps://www.facebook.com/ayato.onichann\nFanpage Support: Mikasa Professor Company\nhttps://www.facebook.com/profile.php?id=100091322097723`, /*attachment: (await axios.get((await axios.get(`https://docs-api.jrtxtracy.repl.co/images/anime?apikey=JRTvip_2200708248`)).data.data, {
                    responseType: 'stream'
                })).data*/
}, event.threadID);
