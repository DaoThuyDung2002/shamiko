...
logger("Hệ thống Bot được HT2K duy trì và phát triển", "🛠 VN");
logger("The System are create and running by HT2K", "🛠 US")
logger("Contact Facebook: www.facebook.com/User.daokieuanh.FAQ", "Facebook");
logger("Contact Zalo: https://zalo.me/0836620317", "Zalo");
logger("Website: ht2k.vn", "Website");
logger("Donate Momo : 0775482335", "DONATE");
logger("Donate TSR - GT1S: 0836623017", "DONATE");

const rainbow = chalkercli.rainbow('\n[=== 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐇𝐓𝟐𝐊 𝐏𝐫𝐨𝐣𝐞𝐜𝐭 ===]\n').stop();

rainbow.render(); 

const frame = rainbow.frame(); 
console.log(frame);
logger("HT2K BOT SUCCESSFULLY INITIALIZED", "HT2K");
logger("Welcome back to HT2K System", "HT2K");
logger("HT2K BOT PROJECT start running...", "HT2K Team");
...
function startBot(message) {
    (message) ? logger(message, "HT2K BOT STARTING") : "";
...
CFonts.say(`Bot Messenger Created By HT2K Team`, {
		font: 'console',
		align: 'center',
		gradient: ['red', 'magenta']
		})
  const rainbow = chalkercli.rainbow('\n[=== 𝐀𝐂𝐓𝐈𝐕𝐄 𝐁𝐎𝐓 𝐇𝐓𝟐𝐊 𝐓𝐞𝐚𝐦 𝐱 𝐌𝐊𝐒𝐂 𝐒𝐭𝐮𝐝𝐢𝐨 ===]\n').stop();
